...
// Utility function to clear invalid fields
...
// Function to render the email body with proper line breaks and spaces
function RenderActualText(body) {
    return body.replace(/\n/g, '<br>').replace(/ {2,}/g, function (match) {
        return match.replace(/ /g, '&nbsp;'); // Replace multiple spaces with non-breaking spaces
    });
}